...
import {
  Divider, List, ListItem, Typography, ListItemIcon, withStyles,
        ...
        <List>
          ...
          {_.map(categories, category => (
            ...
            >
              <ListItem button className={classes.menuItem}>
                ...
                <Typography color="inherit">{capitalize(category.name)}</Typography>
              </ListItem>
            </Link>
          ))}
          ...
          <Link to="/post/new" style={linkStyling}>
            <ListItem button className={classes.menuItem}>
              ...
              <Typography color="inherit">New Post</Typography>
            </ListItem>
          </Link>
        </List>
      );
